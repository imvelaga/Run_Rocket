...
cursor = conn.cursor()
#cursor.execute("SELECT x.ticker_name FROM track_it.stock_master x where serial_no > 420417 and  serial_no < %s and is_available is false order by serial_no",((serial_to,)))
